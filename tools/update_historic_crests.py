#!/usr/bin/env python3
"""Build Middletown Township's Stone Harbor-gauge historic storm-tide archive.
...
MINOR_FLOOD_NAVD88_FT = 3.07
PEAK_ENDPOINT = "https://nwis.waterdata.usgs.gov/nwis/peak"
STATIONS = (
    {
        "site_no": "01407535",
        "station_name": "Navesink River at Red Bank NJ",
        "station_short": "Sea Bright",
    ...
    for attempt in range(attempts):
        try:
            request = urllib.request.Request(
                url,
                headers={"User-Agent": "Middletown-Township-floodmapper-2.0/1.0"},
            )
...
def build(cache_dir: Path | None = None) -> dict:
    ...
    return {
        ...
        "thresholdsNAVD88": {"minorLow":3.07,"moderateLow":4.07,"majorLow":5.07},
        "thresholdsMLLW": {"minorLow":5.2,"moderateLow":6.2,"majorLow":7.2},
        "navd88OffsetFromMllwFt": -2.13,
